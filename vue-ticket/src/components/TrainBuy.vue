<template>
    ...
    <div class="card-body">
      ...
      <div class="text5">
      <h5 class="card-text"><i class="bi bi-train-front fs-2 ms-2 ms-5"></i>{{ route.params.city1 }}<i class="bi bi-arrow-left ms-5 me-5"></i>{{ route.params.city2 }}</h5>
  ...
  <div class="information">
    ...
    <ul class="links-info1">
      ...
      <li>
        <p style="font-weight: bold;"><i class="bi bi-train-front ms-2" style="color:#ffc107"></i>مقصد : {{ route.params.city2 }}</p>
      </li>
      <li>
        <p style="font-weight: bold;"><i class="bi bi-clipboard-check ms-2" style="color:#ffc107"></i>نوع قطار : ویژه</p>
      </li>
      <li>
        <p style="font-weight: bold;"><i class="bi bi-calendar-day ms-2" style="color:#ffc107"></i>تاریخ حرکت : {{ route.params.day}}</p>
      </li>
      <li>
        <p style="font-weight: bold;"><i class="bi bi-alarm ms-2" style="color:#ffc107"></i>ساعت حرکت : 17 عصر</p>
      </li>
      <li>
